...
df =  pd.read_csv('C:/2020-2021/Data/Datasets/Slammer/dataset_slammer_513_1_rrc04_balancedF.csv', delimiter=',', index_col=False)
...
datasetconca.to_csv('C:/2020-2021/Data/Datasets/Slammer/dataset_slammer_513_1_rrc04_EqualF.csv')
