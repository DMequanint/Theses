...
dfsource = pd.read_csv('C:/2020-2021/Data/Datasets/Nimda/dataset_nimda_513_1_rrc04_balancedF.csv', delimiter=',')
...
#df["timestamp"] = pd.to_datetime(dfsource["timestamp2"],format='%Y-%m-%d %H:%M:%S.%f')
...
#df["caseID"] = "N0" + df["caseID"].astype(str) 
...
#df['timestamp'] = pd.to_datetime(df['timestamp2'])
cnt=1
...
df.to_csv('C:/2020-2021/Data/Datasets/Nimda/dataset_nimda_513_1_rrc04_V2.csv', index=False)
...
df1.to_csv('C:/2020-2021/Data/Datasets/Nimda/dataset_nimda_513_1_rrc04_V3.csv', index=False)
...
df3.to_csv('C:/2020-2021/Data/Datasets/Nimda/caseIDLookUp.csv', index=False)
#caseID = df3["caseID"]
dfr = pd.merge(df3, df1, how="inner", on="eventType", validate="one_to_many")
dfro= dfr.sort_values(by=['timestamp'])
dfro.to_csv('C:/2020-2021/Data/Datasets/Nimda/dataset_nimda_513_1_rrc04_MergedO.csv', index=False)
