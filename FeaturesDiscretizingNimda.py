...
df =  pd.read_csv('C:/2020-2021/Data/Datasets/Nimda/dataset_nimda_513_1_rrc04_balancedF.csv', delimiter=',', index_col=False)
...
datasetconca.to_csv('C:/2020-2021/Data/Datasets/Nimda/dataset_nimda_513_1_rrc04_EqualF.csv')
