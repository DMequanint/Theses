...
df =  pd.read_csv('C:/2020-2021/Data/Datasets/AWSLeakPlot/dataset_aws-leak_15547_1_rrc04_balanced.csv', delimiter=',', index_col=False)
...
trans = EqualFrequencyDiscretiser(q=20, variables=['announcements', 'nlri_ann', 'withdrawals', 'origin_changes', 'number_rare_ases', 'as_path_max', 'imp_wd',
...
datasetconca.to_csv('C:/2020-2021/Data/Datasets/dataset_aws-leak_15547_1_rrc04_EqualF.csv')
