...
dfsource = pd.read_csv('C:/2020-2021/Data/Datasets/CombinedDataset/dataset_combined_1_rrc04_EqualF.csv', delimiter=',')
...
df.to_csv('C:/2020-2021/Data/Datasets/CombinedDataset/dataset_combined_1_rrc04_V2.csv', index=False)
...
df1.to_csv('C:/2020-2021/Data/Datasets/CombinedDataset/dataset_combined_1_rrc04_V3.csv', index=False)
...
df3.to_csv('C:/2020-2021/Data/Datasets/CombinedDataset/caseIDLookUp.csv', index=False)
#caseID = df3["caseID"]
dfr = pd.merge(df3, df1, how="inner", on="eventType", validate="one_to_many")
dfro= dfr.sort_values(by=['timestamp'])
dfro.to_csv('C:/2020-2021/Data/Datasets/CombinedDataset/dataset_combined_1_rrc04_MergedO.csv', index=False)
