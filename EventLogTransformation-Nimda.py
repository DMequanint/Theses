...
dfsource = pd.read_csv('C:/2020-2021/Data/Datasets/dataset_nimda_513_5_rrc04.csv', delimiter=',')
...
df.to_csv('C:/2020-2021/Data/Datasets/dataset_nimda_513_5_rrc04_V2.csv', index=False)
df.head(100)
